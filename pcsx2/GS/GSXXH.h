...
static u64 __forceinline GSXXH3_64bits(const void* data, size_t len)
{
...
static XXH_errorcode __forceinline GSXXH3_64bits_update(XXH3_state_t* state, const void* input, size_t len)
{
...
static u64 __forceinline GSXXH3_64bits_digest(XXH3_state_t* state)
{
